...
echo "$($PSQL "SELECT distinct name FROM teams INNER JOIN games ON (games.winner_id = teams.team_id OR games.opponent_id = teams.team_id) AND year = 2014 AND round = 'Eighth-Final' ORDER BY name")"
